...
class GameTableDialog(QDialog):
    ...
    def __init__(self, players, parent=None):
        ...
        self.set_column_style(0, 0, 1, Qt.AlignHCenter, 'Purple', 'LightCyan', 13, 75)
        self.table.item(0, 0).setBackground(QColor('DarkGray'))
    ...
    def add_row(self, row, colors):
        ...
        for i, s in enumerate(row):
            self.table.setItem(r, i, QTableWidgetItem(f'{s}'))

        self.set_column_style(0, r, r, Qt.AlignHCenter, colors[0], 'LightCyan', 13, 70)
