"""
Здесь расположены методы обработчики точек входа для api, зарегистрированные в router.py.
В данном модуле должно быть минимум логики, только маршрутизация.
"""
